...
public class MainApp extends Application {
    ...
    private static Parent loadFXML(String fxml) throws IOException {
        FXMLLoader fxmlLoader = new FXMLLoader(MainApp.class.getResource("/uk/ac/rgu/cm2115/" + fxml + ".fxml"));
    ...
    public static <T> void setScene(String fxml, T model) throws IOException {
        ...
        FXMLLoader loader = new FXMLLoader(MainApp.class.getResource("/uk/ac/rgu/cm2115/" + fxml + ".fxml"));
